...
<nav class="bg-black fixed w-full z-30 border-gray-200 dark:bg-gray-900 dark:border-gray-700">
      ...
      <div class="hidden  w-full md:block md:w-auto" id="navbar-multi-level">
          ...
          <li>
            ...
            <span class="f-ui-1 underline-thickness-1 underline-offset-4 hover:underline group-hover:decoration-[rgba(var(--text-primary-rgb),0.2)]">
              <a href="{{ route('user.home') }}" class="block py-2 pl-3 pr-4 text-white bg-gray-900 rounded md:bg-transparent md:text-white md:p-0 md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent" aria-current="page">Home</a>
            </span>
                @endauth
            </li>
          <li>
          ...
          <li>
            <span class="f-ui-1 underline-thickness-1 underline-offset-4 hover:underline group-hover:decoration-[rgba(var(--text-primary-rgb),0.2)]">
                <a href="{{ route('logout') }}" class="block py-2 pl-3 pr-4 text-white rounded hover:bg-gray-900 md:hover:bg-transparent md:border-0  md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Logout</a>
            </span>
          </li>
            @endauth
        </ul>
